...
import type { ScheduleSlot, SlotStatus, TemplateWithRules } from '@/features/schedule/api';
import { useEmployeesQuery } from '@/features/employees';
import { useStoreEffectiveTemplateQuery, useScheduleTemplateQuery, useScheduleSlotsQuery } from '@/features/schedule/queries';
import { useMaterializeTemplateMutation, useAssignSurveyorMutation } from '@/features/schedule/mutations';
...
import TemplateCard from '@/features/schedule/components/TemplateCard';
import TemplateBuilderDialog from '@/features/schedule/components/TemplateBuilderDialog';
